...
| `--plugin` | *(none)* | Framework plugin: `webui` for WebUI Framework, `fast-v3` for @microsoft/fast-element 3.x hydration, or deprecated `fast-v2`/`fast` for @microsoft/fast-element 2.x compatibility |
