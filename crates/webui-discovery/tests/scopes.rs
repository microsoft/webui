...
fn fast_scope_skips_non_components_but_reports_declared_missing_assets() -> TestResult {
    ...
    let component = package(
        ...
        "exports":{"./template.html":"./button.template.html"}
    }"#,
    )?;
    ...
    fs::write(
        component.join("button.template.html"),
...
fn fast_manifest_components_take_precedence_and_plain_components_fill_gaps() -> TestResult {
    ...
    let mixed = package(
        ...
        r#"{
        "customElements":"custom-elements.json",
        "exports":{"./template.html":"./dist/button.template.html"}
    }"#,
    )?;
    ...
    fs::write(
        mixed.join("dist/button.template.html"),
