...
// src/navigation-path.ts
function stripBaseFromPathname(pathname, basePath = "") {
  if (basePath && pathname.startsWith(basePath)) {
    return pathname.slice(basePath.length) || "/";
  }
  return pathname;
}
function buildNavigationTarget(url, basePath = "") {
...
function prependBasePath(path, basePath = "") {
