...
- Authored browser entries execute only after their component markup has been
  parsed. Non-async ES module scripts satisfy this automatically; classic
  scripts must appear after the component markup they define. Under this
  loading contract, `TemplateElement.connectedCallback()` hydrates synchronously, so
